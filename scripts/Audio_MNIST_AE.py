...
AE_classification_testing_list, AE_classification_testing_loss, AE_classification_testing_accuracy = test_model(autoencoder, dataset_test=mnist_audio_test, batch_size=BATCH_SIZE_AE)
